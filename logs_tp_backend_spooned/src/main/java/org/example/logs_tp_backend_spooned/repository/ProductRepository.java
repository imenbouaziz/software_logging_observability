package org.example.logs_tp_backend_spooned.repository;
...
public class ProductRepository {
    ...
    public void addProduct(int userId, Product product) {
        DatabaseReference counterRef = FirebaseDatabase.getInstance().getReference("counters/products").child(String.valueOf(userId));
    ...
    public CompletableFuture<List<Product>> fetchAllProducts(int userId) {
        ...
        productRef.child(String.valueOf(userId)).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot snapshot) {
    ...
    public CompletableFuture<List<Product>> findTopProducts() {
        ...
        productRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                List<Product> top10 = allProducts.stream().limit(5).collect(Collectors.toList());
